...
*Goal: Transform the current broker into a robust state-management and job-queue system.*
...
*Goal: Ensure the client is the master of its own conversation history.*
...
*Goal: Create a standalone service that connects everything together.*
...
- [ ] **Tool Execution (Remote):**
    ...
    - [ ] Execute tools (bash, read, write) directly on Client VM over the *existing* SSH session.
- [ ] **Resilience:**
